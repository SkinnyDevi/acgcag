...
2. Move this to files to where you found this text file.
3. (OPTIONAL) You may rename this shortcut to something like 'Launcher'
4. Enjoy not having to search endlessly through a lot of files to find the App!
